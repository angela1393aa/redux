...
import {
  ...
  coffeeBeanRestocked,
  selectCoffeeBean,
} from "../features/slices/coffeeBeanSlice";
    ...
    <div>
      ...
      <fieldset>
        ...
        <div>
          ...
          <input
            id="coffeeBeanOrderQty"
            type="number"
            ref={coffeeBeanOrderQtyRef}
          />
        </div>
        <div>
          <label htmlFor="coffeeBeanOrderMoney">價錢</label>
          <input
            id="coffeeBeanOrderMoney"
            type="number"
            ref={coffeeBeanOrderMoneyRef}
          />
        </div>
        <button onClick={doOrderCoffeeBean}>購買</button>
      </fieldset>
      <fieldset>
        <legend>咖啡豆進貨</legend>
        <div>
          ...
          <input
            id="coffeeBeanRestockQty"
            type="number"
            ref={coffeeBeanRestockQtyRef}
          />
        </div>
        <div>
          <label htmlFor="coffeeBeanRestockMoney">價錢</label>
          <input
            id="coffeeBeanRestockMoney"
            type="number"
            ref={coffeeBeanRestockMoneyRef}
          />
        </div>
        <button onClick={doRestockCoffeeBean}>進貨</button>
      </fieldset>
    </div>
  );
};
